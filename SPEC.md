...
- [x] RAG 质量评测默认中文用例（普通向量召回 vs Advanced RAG）
- [x] RAG 质量评测报告 API（命中率、引用命中率、提升用例）
- [x] 已上传文档详情窗口可拖动调整宽度
...
- [x] GitHub README 桌面横屏 RAG 主链路截图（上传、入库、文档详情、普通问答、多轮追问、Advanced RAG、引用片段定位、质量评测）
- [x] 面试讲解与答辩提纲（RAG 主线、设计取舍、高频追问、本地验收清单）
