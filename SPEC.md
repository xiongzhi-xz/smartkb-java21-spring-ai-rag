...
- [x] 刷新页面后同一 conversationId 技术问题，LLM 能记住之前的对话
- [x] 重启 Spring Boot 后同一 conversationId 技术问题，LLM 能记住之前的对话
- [x] Advanced 模式同样共享 conversationId，技术问题时查询改写能基于历史
...
Eval 技术讲解总结见：`docs/EVAL_TECHNICAL_SUMMARY.md`。
