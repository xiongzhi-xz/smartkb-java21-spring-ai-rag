...
public record RagEvalCaseResult(
        ...
        List<String> baselineMatchedChunkIds,
        List<String> advancedMatchedChunkIds,
        int baselineFirstHitRank,
        int advancedFirstHitRank,
        boolean baselineTop1Hit,
        boolean advancedTop1Hit,
        double baselineMrr,
        double advancedMrr,
