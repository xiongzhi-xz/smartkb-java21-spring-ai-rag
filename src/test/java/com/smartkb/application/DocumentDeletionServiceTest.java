...
class DocumentDeletionServiceTest {
    ...
    void shouldDeleteReadyDocumentInProtectedOrder() {
        ...
        DocumentDeletionResult result = service(repository, indexCleaner, objectStorage)
                .delete(ready.document().id());

        assertThat(result.deletedChunks()).isEqualTo(3);
        assertThat(result.fileName()).isEqualTo("demo.md");
        InOrder order = inOrder(repository, indexCleaner, objectStorage);
    ...
    void shouldAllowFailedDocumentDeletion() {
        ...
        assertThat(service(repository, indexCleaner, objectStorage).delete(failed.document().id()))
    ...
    void shouldRejectActiveDocumentWithoutExternalCleanup() {
        ...
        assertThatThrownBy(() -> service(repository, indexCleaner, objectStorage)
    ...
    private DocumentDeletionService service(
        ...
        return new DocumentDeletionService(repository, indexCleaner, objectStorage);
    }
