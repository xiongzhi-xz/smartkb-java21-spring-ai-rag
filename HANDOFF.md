...
Current goal:
- Keep SmartKB as a stable GitHub-facing Java 21 + Spring AI RAG / Agent engineering showcase without adding new features.
...
- Local branch was already ahead of origin before this docs-only pass.
