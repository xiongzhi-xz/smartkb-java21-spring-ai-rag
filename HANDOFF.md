...
- The next focused implementation task is Phase 3e: implement idempotent Milvus/OpenSearch deletion before MinIO/PostgreSQL cleanup and add a Compose-backed smoke test or container integration verification.
