...
4. [docs/INTERVIEW_TALK_TRACK.md](INTERVIEW_TALK_TRACK.md)：看项目讲解、面试追问和本地验收清单。
5. [SPEC.md](../SPEC.md)：看已完成范围、验收记录和不继续扩展的边界。
6. [docs/AGENT_PLATFORM_SPEC.md](AGENT_PLATFORM_SPEC.md)：可选阅读，了解 SmartKB v2 Agent 平台实验设计。
...
- RAG Eval 默认中文用例、服务层统计和 Web API 结构已覆盖测试。
