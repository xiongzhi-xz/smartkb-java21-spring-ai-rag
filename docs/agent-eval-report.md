...
| E10 | 生成设计说明 | 通过 | 2 | 0 | 能说明清楚项目链路、技术取舍和 SmartKB eval 关系 |
...
- 有 2 分钟版回答。
- 有 3-5 个项目说明设计问题。
- 能把 TicketRush 和 SmartKB v2 的 eval 关系说明清楚。
...
- E07 验证了受控评审能力，能把 Docker profile 健康检查改动的风险、影响范围和验证路径说明清楚，同时不越权修改代码。
