...
- [ ] Phase 3a (20-30 min): add immutable chunk/candidate domain records and outbound ports for index write, delete, and retrieval; unit-test idempotent payload construction.
- [ ] Phase 3b (20-30 min): add Milvus and OpenSearch Docker Compose services, configuration properties, health checks, and client adapters. Add no schema migration in this task.
